...
function setup() {
	...
	//rope1 = new Rope(roof1.body,bobObject1.body,- 80*2,0);
	//rope2 = new Rope(roof1.body,bobObject2.body,- 80*2,0);
	//rope3 = new Rope(roof1.body,bobObject3.body,- 80*2,0);
	//rope4 = new Rope(roof1.body,bobObject4.body,- 80*2,0);
	//rope5 = new Rope(roof1.body,bobObject5.body,- 80*2,0);
